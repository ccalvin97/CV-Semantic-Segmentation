...
class check_x_size():
    def __init__(self, path, path_filter, threshold=770):
        '''
...
#        help='data out abs address for picture ex:C:\\Users\\heca0002\\Desktop\\GIS\\map_example\\data_excel ')   
    parser.add_argument('-size', '--size', type=str, default=770,
            help='size of threshold for detection')
    args = parser.parse_args()



    check_x_size(args.path_map, args.path_filter).check_size()
